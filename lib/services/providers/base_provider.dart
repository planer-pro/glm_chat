...
abstract class AIProvider {
  ...
  /// Список поддерживаемых моделей для валидации.
  List<String> get supportedModels;

  /// Проверяет, является ли модель поддерживаемой для этого провайдера.
  ///
  /// Параметр [modelName] - название модели для проверки.
  /// Возвращает true, если модель поддерживается, иначе false.
  bool isModelSupported(String modelName);

  /// Получает человекочитаемое сообщение об ошибке для неподдерживаемой модели.
  ///
  /// Параметр [modelName] - неподдерживаемое название модели.
  /// Возвращает сообщение с рекомендациями.
